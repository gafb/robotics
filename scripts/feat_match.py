...
class ImageFeature:
	...
	def __init__(self):
		...
		self.image_pub = rospy.Publisher("/vision_object",
			String, queue_size = 10)
		# self.bridge = CvBridge()
		if (len(sys.argv) == 2):
			self.objeto_img = cv2.imread(sys.argv[1])
			# subscribed Topic
			...
			print("You should pass only one parameter after .py file")
	...
	def callback(self, ros_data):
		...
		kp1 = detector.detect(self.objeto_img)
		kp1, des1 = descriptor.compute(self.objeto_img, kp1)
