...
"""
If a person is found the robot will offer the hand, else will put arm in home position
...
Test:
And move the robot the look to a person and to stop looking

OBS:
It's better if the robot is stopped to offer the hand (avoiding collisions)
"""
def show_usage():
